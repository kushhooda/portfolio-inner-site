        ...
        <div className="site-page-content">
            <div style={styles.header}>
                ...
                <div style={styles.socials}>
                    <SocialBox
                        icon={ghIcon}
                        link={'https://github.com/kushhooda'}
                    />
                    <SocialBox
                        icon={inIcon}
                        link={'https://www.linkedin.com/in/kushhooda/'}
                    />
                    <SocialBox
                        icon={twitterIcon}
                        link={'https://www.instagram.com/whykushh/'}
                    />
                </div>
            </div>
            <div className="text-block">
                <p>
                    ...
                    reach me via my personal email, or fill out the form below!
                </p>
                <br />
                <p>
                    <b>Email: </b>
